    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_type', models.CharField(choices=[('COD', 'Cash on Delivery'), ('Gateway', 'Payment Gateway')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_attr', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.productattribute')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('Reg', 'Registered'), ('Not-Reg', 'Not Registered')], max_length=10)),
                ('qty', models.PositiveIntegerField()),
                ('added_on', models.DateTimeField(auto_now_add=True)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.product')),
                ('product_attr', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.productattribute')),
